...
const UserContextHeader = ({ isCollapsed = false }) => {
  ...
  return (
    <div className="p-4 border-b border-border bg-muted/30">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h4 className="font-semibold text-sm text-foreground truncate capitalize">
              {userInfo.name}
            </h4>
          ...
          {/* Gamification Stats - Same styling as Sidebar */}
        ...
        >
          <Icon 
            name="Bell" 
            size={18} 
            className={notifications > 0 ? "text-primary" : "text-muted-foreground"} 
          />
          {notifications > 0 && (
      ...
      <div className="mt-3 pt-3 border-t border-border/50">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-xs font-mono text-foreground">
            {userInfo.completedModules}/5 modules
          </span>
        </div>
      ...
      {/* Department Info - Additional info not in sidebar */}
