  ...
  return (
    <div className={cn("relative w-full", className)}>
      ...
      <div className="relative">
        <textarea ref={ref} id={textareaId} name={name} rows={rows} disabled={disabled} placeholder={placeholder} className={cn("flex w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 resize-none min-h-[80px]", error && "border-destructive focus:ring-destructive", className)} {...props} />
      </div>
