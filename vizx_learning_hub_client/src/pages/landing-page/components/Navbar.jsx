        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <img 
              ...
              className="h-16 lg:h-16 object-contain cursor-pointer"
              onClick={() => navigate("/")}
            />
          </motion.div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            {navItems.map((item, index) => (
              ...
              >
                <motion.a
                  href={item.href}
                  className="flex items-center text-gray-700 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400 transition-colors duration-200 font-medium text-sm lg:text-base relative py-2 px-3 rounded-lg"
                  whileHover={{ scale: 1.05 }}
                >
                  {item.label}
                  {item.subMenu && (
                    ...
                    <div className="py-2">
                      {item.subMenu.map((subItem) => (
                        <a
                          key={subItem.label}
                          href={subItem.href}
                          className="block px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 dark:hover:text-orange-400 transition-colors"
                        >
                          {subItem.label}
                        </a>
                      ))}
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                <Button 
                  ...
                  className="font-semibold bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700"
                  size="sm"
                >
                  Sign In
                </Button>
              ...
              >
                <Button 
                  ...
                  className="font-semibold bg-orange-500 hover:bg-orange-600 text-white border-0"
                  size="sm"
                >
                  Sign Up
                </Button>
            ...
            >
              <div className="flex flex-col space-y-2">
                ...
                >
                  <Button 
                    onClick={handleSignIn}
                    className="w-full font-semibold bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700"
                  >
                    Sign In
                  </Button>
                  ...
                  <Button 
                    onClick={handleSignUp}
                    className="w-full font-semibold bg-orange-500 hover:bg-orange-600 text-white border-0"
                  >
                    Sign Up
                  </Button>
                </motion.div>
