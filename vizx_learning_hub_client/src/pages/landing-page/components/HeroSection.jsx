...
const HeroSection = () => {
  ...
  // Function to get color class based on metric
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-background via-background to-muted/30 dark:to-gray-900/30 pt-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-6xl font-bold tracking-tight">
                Master{" "}
                <span className="text-gradient bg-gradient-to-r from-primary to-ring">
                  In-Demand Skills
                </span>
                <br />
                <span className="relative">
                  ...
                  <span className="relative">
                    Learning
                    <div className="absolute -bottom-2 left-0 right-0 h-3 bg-primary/20 -rotate-1"></div>
                  </span>
                </span>
              </h1>
              ...
              <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl">
                ...
                immersive AI-driven learning platform. Experience education reimagined 
                with gamification, real-time feedback, and personalized pathways.
              </p>
            </motion.div>
            ...
            >
              <Button
                ...
                className="group px-8 py-3 text-lg font-semibold rounded-xl bg-primary hover:bg-ring text-primary-foreground transition-all duration-300 hover:shadow-xl hover:shadow-primary/25"
              >
                Start Learning Free
              ...
              <Button
                ...
                variant="outline"
                className="px-8 py-3 text-lg font-semibold rounded-xl border-2 border-primary/30 hover:border-primary hover:bg-primary/10"
              >
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              className="relative rounded-3xl overflow-hidden shadow-2xl border border-border bg-gradient-to-br from-card to-popover"
            >
              ...
              {/* Floating Learning Path Cards */}
              <div className="absolute -bottom-6 -right-6 lg:-bottom-12 lg:-right-12">
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: 0.6 }}
                  className="bg-card rounded-2xl shadow-2xl border border-border p-4 w-64"
                >
                  ...
                  <div className="space-y-3">
                    {learningPaths.map((path, index) => (
                      <motion.div
                        ...
                        onClick={() => navigate(`/category/${path.category.toLowerCase()}`)}
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-muted-foreground">{path.students} students</p>
                        </div>
      ...
      <div className="absolute top-40 right-20 animate-float-delayed">
        <div className="w-8 h-8 rounded-full bg-ring/20"></div>
      </div>
