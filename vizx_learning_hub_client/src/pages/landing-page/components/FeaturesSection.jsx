  ...
  const platformHighlights = [
    {
      ...
      description: "AI-powered recommendations based on your role, skill level, and career goals.",
      stat: "95% Relevance"
    },
    {
      icon: Zap,
      title: "Fast Skill Acquisition",
      description: "Accelerated learning through bite-sized modules and practical application.",
      stat: "2x Faster"
    },
    {
      icon: Star,
      title: "Industry Recognition",
      description: "Certificates recognized by leading companies and industry bodies.",
      stat: "100+ Partners"
    },
    {
      icon: Clock,
      title: "Flexible Scheduling",
      description: "Learn at your own pace with 24/7 access to all learning materials.",
      stat: "24/7 Access"
    }
  ];
      ...
      <div className="container relative mx-auto px-4 lg:px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            A comprehensive AI-powered learning platform designed for modern workforce development, 
            combining the best of Udemy's course structure with innovative engagement features.
          </p>
        </motion.div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-card rounded-xl border border-border p-6 h-full transition-all duration-300 hover:shadow-xl hover:border-primary/50 hover-lift">
                {/* Feature Icon */}
                <div className="mb-5">
                  <div className={`relative w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color} p-3 flex items-center justify-center`}>
