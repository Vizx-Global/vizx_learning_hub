      ...
      <div className="container mx-auto px-4 lg:px-6">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">
            Learning Made <span className="text-gradient">Fun & Engaging</span>
          </h2>
          
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Turn skill development into an exciting experience with interactive games, 
            challenges, and rewards that keep everyone motivated
          </p>
        </motion.div>

        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12 lg:mb-16">
          {/* Left Column - Games Showcase */}
          <div>
          ...
          {/* Right Column - Live Demo & Leaderboard */}
          <div>
            {/* Game Preview */}
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="px-3 py-1 text-sm font-medium rounded-full bg-gradient-to-r from-primary to-ring text-primary-foreground">
                  Live Demo
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden border border-border bg-gradient-to-br from-card to-popover">
                ...
                <div className="p-4 border-b border-border bg-muted/50 flex items-center gap-2">
                  ...
                  <div className="ml-4 text-sm text-muted-foreground">
                    {games[activeGame].title} • Play Now
                  </div>
                </div>
                ...
                <div className="p-8">
                  ...
                  <div className="text-center mb-6">
                    <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-primary/10 to-ring/10 mb-4">
                      {(() => {
                        const GameIcon = games[activeGame].icon;
                        return <GameIcon className="w-12 h-12 text-primary" />;
                      })()}
                    </div>
                  ...
                  <div className="bg-muted/30 rounded-xl p-4 mb-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-semibold text-foreground">+{games[activeGame].points.split(" ")[0]}</span>
                    </div>
                  ...
                  {/* Play Button */}
                  <Button className="w-full py-3 bg-gradient-to-r from-primary to-ring text-primary-foreground font-semibold hover:shadow-lg hover:shadow-primary/25 transition-all duration-300">
              ...
              <div className="bg-card rounded-xl border border-border overflow-hidden">
                <div className="p-4 border-b border-border bg-muted/50">
                  <div className="flex items-center justify-between">
                    <span className="font-semibold text-foreground">Top Performers</span>
                  ...
                  {leaderboardSample.map((player, index) => (
                    <motion.div
                      ...
                      className={`flex items-center gap-4 p-3 rounded-lg mb-2 ${
                        index === 0 
                          ? "bg-gradient-to-r from-primary/10 to-ring/10 border border-primary/20"
                          : "hover:bg-muted/30"
                      }`}
                    >
        ...
        >
          <div className="bg-gradient-to-r from-primary/5 to-ring/5 rounded-2xl p-8 border border-primary/10 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
              Transform traditional training into an engaging experience with 
              games, challenges, and rewards that actually work
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                onClick={() => window.location.href = '/register'}
                className="px-8 py-3 bg-gradient-to-r from-primary to-ring text-primary-foreground font-semibold rounded-xl hover:shadow-lg hover:shadow-primary/25 transition-all duration-300"
              >
                Start Playing
