  ...
  const aiInsights = [
    {
      ...
      description: 'Engineering cohort shows 23% higher engagement with hands-on labs. Consider increasing practical exercises for Sales cohort to boost completion rates.',
      color: 'success'
    },
    {
      id: 2,
      ...
      icon: 'AlertCircle',
      title: 'At-Risk Alert',
      description: '12 learners in Q2 2024 cohort have been inactive for 7+ days. Automated reminder emails have been sent to re-engage these users.',
      color: 'warning'
    },
    {
      id: 3,
      ...
      description: 'Learners who complete modules in the morning have 18% higher retention. Consider scheduling push notifications for 9-11 AM.',
      color: 'primary'
    },
    {
      id: 4,
      ...
      description: 'Leadership cohort maintains 90%+ completion through peer learning sessions. Recommend implementing similar group activities for other cohorts.',
      color: 'success'
    }
  ];

  const currentCohort = cohorts.find(c => c.id === selectedCohort) || cohorts[0];
  const cohortComparison = cohorts.slice(1).map(cohort => ({
    name: cohort.name,
    completion: cohort.avgCompletion,
    engagement: cohort.avgCompletion + Math.random() * 10,
    assessment: cohort.avgScore
  }));
      ...
      `}>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Track and analyze learning cohort progress and engagement
                </p>
              </div>
            </div>
        ...
        <main className="p-4 space-y-6">
          ...
          <TopPerformersTable
            ...
            onViewAll={() => navigate('/gamification-leaderboards')}
          />
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Button
                ...
                iconName="Users"
                iconPosition="left"
                onClick={() => navigate('/learning-path-management')}
              >
              ...
              <Button
                ...
                iconName="BarChart3"
                iconPosition="left"
                onClick={() => navigate('/learning-analytics-export-center')}
              >
                Advanced Analytics
              </Button>
              <Button
