...
import { User, Lock, Mail, Phone, Briefcase, FileText, AlertCircle, ArrowLeft, Camera, Upload } from 'lucide-react';
      ...
      <div className="flex-grow pt-24 pb-12 px-4 sm:px-6">
        ...
        <div className="max-w-7xl mx-auto">
            <div className="mb-8 flex items-center gap-4">
                 <Button variant="ghost" onClick={() => navigate(-1)} className="p-2 h-auto text-muted-foreground hover:text-foreground">
                    <ArrowLeft size={24} />
                 </Button>
                <div>
            ...
            <div className="w-full md:w-64 flex-shrink-0 space-y-2">
                <div className="p-6 bg-card rounded-2xl border border-border/50 shadow-sm text-center mb-6">
                    ...
                    <p className="text-sm text-muted-foreground">{user?.jobTitle || 'Learner'}</p>
