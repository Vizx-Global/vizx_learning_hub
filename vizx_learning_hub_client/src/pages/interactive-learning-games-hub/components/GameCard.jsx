  ...
  return (
    <div className={`bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 group ${className}`}>
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {/* Live Indicator */}
        {game?.isLive && (
          <div className="absolute bottom-3 right-3 flex items-center gap-1 bg-success text-success-foreground px-2 py-1 rounded-full">
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">{game?.participants}</p>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">{game?.avgTime}</p>
