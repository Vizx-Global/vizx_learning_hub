...
router.get('/all', authorize('ADMIN', 'MANAGER', 'EMPLOYEE'), validate(userQuerySchema, 'query'), UserController.getAllUsers);
...
router.get('/:id/activity-summary', UserController.getUserActivitySummary);
