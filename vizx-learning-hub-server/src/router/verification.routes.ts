...
router.get(
  ...
  VerificationController.validateResetToken
);
router.post(
  '/complete-password-reset',
  validate(completePasswordResetSchema),
  VerificationController.completePasswordReset
);
router.post(
  '/verify',
  authenticate,
...
router.post(
  ...
  VerificationController.forcePasswordChange
);
router.get(
  '/status',
  authenticate,
...
router.post(
  ...
  VerificationController.createEmployeeByManager
);
router.get(
  '/manager/employees/:employeeId',
  authenticate,
  authorize('MANAGER'),
  VerificationController.getManagerEmployeeById
);
router.put(
  '/manager/employees/:employeeId',
  authenticate,
  authorize('MANAGER'),
  validate(createEmployeeSchema), 
  VerificationController.updateEmployeeByManager
);
router.delete(
  '/manager/employees/:employeeId',
  authenticate,
  authorize('MANAGER'),
  VerificationController.deactivateEmployee
);
router.post(
  '/admin/reset-password/:userId',
  authenticate,
  authorize('ADMIN'),
  VerificationController.resetPasswordByAdmin
);
router.post(
  '/test-email',
  authenticate,
  authorize('ADMIN'),
  VerificationController.testEmailService
);
